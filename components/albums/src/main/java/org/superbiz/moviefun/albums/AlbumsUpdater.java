...
public class AlbumsUpdater {
    ...
    public AlbumsUpdater(BlobStore blobStore, AlbumRepository albumRepository) {
    ...
    public void update() throws IOException {
        ...
        List<Album> albumsWeHave = (List<Album>)albumRepository.findAll();
    ...
    private void createNewAlbums(List<Album> albumsToHave, List<Album> albumsWeHave) {
        ...
        albumsToCreate.forEach(albumRepository::save);
    }
    ...
    private void deleteOldAlbums(List<Album> albumsToHave, List<Album> albumsWeHave) {
        ...
        albumsToDelete.forEach(albumRepository::delete);
    }
    ...
    private void updateExistingAlbums(List<Album> albumsToHave, List<Album> albumsWeHave) {
        ...
        albumsToUpdate.forEach(albumRepository::save);
    }
